...
Version 0.1.0 has no third-party runtime dependency and contains no copied third-party source code. It uses Python's standard-library `sqlite3`, `json`, `argparse`, and related modules.
