# Cassian Atlas third-party notices

Version 0.5.0 has no required third-party runtime dependency and contains no copied third-party source code. It uses Python's standard-library `sqlite3`, `json`, `argparse`, and related modules.
