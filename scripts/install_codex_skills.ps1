...
$backupRoot = Join-Path $resolvedTarget '.open-tutor-ledger-backups'
...
[pscustomobject]@{
    ...
    skills = $installed
    preferred_cli = 'opentutor'
    legacy_cli_aliases = @('open-tutor-ledger', 'english-tracker', 'python -m english_tracker')
