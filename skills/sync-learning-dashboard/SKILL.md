...
description: Register and update specialist task runs in a Cassian Atlas dashboard without changing learning evidence. Use when a router or specialist agent starts, progresses, completes, fails, is cancelled, or needs user input, and when the dashboard must show current automation status without a handwritten handoff.
---
