...
description: Diagnose the active learner's reading and exercise mistakes from stored item evidence while separating question knowledge points from student error causes. Use for wrong-question review, reading passage analysis, distractor diagnosis, tentative weak points, or writing model-suggested error causes back to an OpenTutor Ledger database.
---
